...
#my $OUTPUT_HOME = $ARGV[0];
#my $DIR_SYSTEM= $ARGV[1];
#my $DIR_GOLD= $ARGV[2];
my $OUTPUT_HOME = '/scratch/tmp_OUTPUT'; #"tmp_OUTPUT"; #where to generate output 
my $DIR_SYSTEM= '/scratch/tmp_PRED'; #"tmp_SYSTEM"; # location of system generated files
my $DIR_GOLD= '/scratch/tmp_GOLD'; #"tmp_GOLD"; # location of gold standard files

print 'output: ' . $OUTPUT_HOME . "\n";
print 'pred: ' . $DIR_SYSTEM . "\n";
print 'gold: ' . $DIR_GOLD . "\n";
`rm -r $OUTPUT_HOME `;
